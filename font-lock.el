...
`objc-font-lock-extra-types', `java-font-lock-extra-types' and `csharp-font-lock-extra-types'."
  (cond (major-mode
 ...
 (setq java-font-lock-keywords-2
  (append java-font-lock-keywords-1
   (list
    ...
    ;; C# xmldoc tags within comments.
    '("@\\(remarks\\|summary\\|exception\\|returns\\|c\\)\\>"
      (1 font-lock-constant-face prepend))
    '("@\\(param\\)\\>[ \t]*\\(\\sw+\\)?"
      (1 font-lock-constant-face prepend)
      (2 font-lock-variable-name-face prepend t))
