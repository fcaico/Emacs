...
;;; maintained under the SourceSafe version control system.  The functions
;;; are defined in the Emacs source-safe package available from Stan Lanning
;;; <lanning@pureatria.com>. SourceSafe is available from Microsoft, and runs 
;;; under Windows NT and Win95.  There are versions of SourceSafe that run on 
...
;;; Installation/Usage:
;;; Byte compile this file and load it together with the source-safe package
