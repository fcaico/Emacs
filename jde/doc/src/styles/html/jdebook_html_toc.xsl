...
<body bgcolor="#FFF7C8">
<h2>Contents</h2>
<applet codebase="../../tli_rbl" archive="tli_rbl.jar" code="tli_rbl.class" width="200" height="400">
...
<xsl:text>jde-ug-content.html#</xsl:text><xsl:value-of select="anchor/@id"/>
</xsl:attribute>
